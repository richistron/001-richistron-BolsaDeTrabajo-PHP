...
*/
/*
function insertarVacante($NombreF, $EmpresaF, $DescripcionF, $CiudadF, $statusF, $pubbyF, $connect)
{
...
function listarVacantes($status, $connect)
{
 ...
 <td>
        ...
        <a href="BolsaAdd">Aplicar a la Vacante</a>
...
if($_POST['addVacanteSubmit'])
{
    ...
    insertarVacante($Nombre, $Empresa, $Descripcion, $Ciudad, $status, $by, $mysqli_connect);
}
...
*/
include "/$home/vistas/vacanteList.inc.php";
?>
